  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-none p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        panel: "w-full bg-transparent p-0 group-data-horizontal/tabs:h-14",
        segment: "w-full bg-transparent p-0 group-data-horizontal/tabs:h-11",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=panel]/tabs-list:h-full group-data-[variant=panel]/tabs-list:justify-start group-data-[variant=panel]/tabs-list:border-0 group-data-[variant=panel]/tabs-list:px-5 group-data-[variant=panel]/tabs-list:text-sm group-data-[variant=panel]/tabs-list:data-active:bg-muted/55 group-data-[variant=panel]/tabs-list:data-active:after:bg-primary group-data-[variant=panel]/tabs-list:data-active:after:opacity-100 dark:group-data-[variant=panel]/tabs-list:data-active:bg-muted/55",
