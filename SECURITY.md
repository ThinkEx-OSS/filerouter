...
FileRouter handles customer documents and credentials. Please report suspected
security issues privately so we can investigate them before public disclosure.

## Reporting a vulnerability

Email [hello@thinkex.app](mailto:hello@thinkex.app?subject=FileRouter%20security%20report)
with the subject `FileRouter security report`.
